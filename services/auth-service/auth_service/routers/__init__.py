...
from auth_service.routers.users import router as users_router, _internal_users_router as internal_users_router
...
__all__ = ["auth_router", "users_router", "internal_users_router", "tokens_router", "internal_router", "admin_router", "oidc_router"]
